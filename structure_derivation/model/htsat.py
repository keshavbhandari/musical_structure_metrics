...
class HTSAT_Swin_Transformer(nn.Module):
    ...
    def __init__(self, config = None, **kwargs):
        ...
        self.htsat_window_size = config.htsat_window_size
        ...
        self.patch_embed = PatchEmbed(
            ...
            embed_dim=self.embed_dim, norm_layer=self.norm_layer, patch_stride = config.patch_stride)
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(dim=int(self.embed_dim * 2 ** i_layer),
                ...
                window_size=self.htsat_window_size,
    ...
    def forward(self, x: torch.Tensor, mixup_lambda = None, infer_mode = False):# out_feat_keys: List[str] = None):
        ...
        if infer_mode:
            ...
            repeat_ratio = math.ceil(target_T / frame_num)
            x = x.repeat(repeats=(1,1,repeat_ratio,1))
